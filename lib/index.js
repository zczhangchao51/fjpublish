...
Fjpublish.prototype._adjustModuleMiddlewares = function() {
    ...
    for (let i in modules) {
        ...
        let { beforeHook, afterHook, middlewareReplace, middlewareUse, middlewareIgnore } = module;
        ...
        if (beforeHook) dealHook(beforeHook, 'before');
        if (afterHook) dealHook(afterHook, 'after');
