...
module.exports = function compress(module, env, next) {
    ...
    let { localPath, localPathEntries, localPathMap, localPathMapStream, localPathIgnore, buildCommand, nobuild, merge, nohistory, diff, localTarFileDir, tarFilename, _latest, _current } = module;
    ...
    let p = this[hashPromiseName] ? this[hashPromiseName] : this[hashPromiseName] = new Promise((resolve, reject) => {
        ...
        option.map = localPathMap ? localPathMap : (header) => {
